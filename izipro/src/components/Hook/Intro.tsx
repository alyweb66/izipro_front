        ...
        <div className="intro-container">
            ...
            <ul className="intro-list">
                <li className="intro-list-item">
                    ...
                    <p>Vous permet de créer une demande qui sera envoyée aux professionnels</p>
                </li>
                <li className="intro-list-item">
                    <strong className="intro-list-item__strong">MES DEMANDES</strong>
                    <p>Vous permet de voir la liste de vos demandes ainsi que vos conversations avec les professionnels</p>
                </li>
                {role === 'pro' && <li className="intro-list-item">
                    <strong className="intro-list-item__strong">CLIENTS</strong> 
                     <p>Vous permet de voir la liste des demandes en fonction de vos métiers choisis et de la distance</p>
                </li>}
                {role === 'pro' && <li className="intro-list-item">
                    <strong className="intro-list-item__strong">MES CLIENTS</strong>  
                    <p>Vous permet de voir la liste des demandes auxquelles vous avez répondu</p>
                </li>}
                <li className="intro-list-item">
